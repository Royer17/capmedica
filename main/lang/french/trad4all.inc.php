...
$ExtendedProfileTitle = "Utiliser le portfolio";
$ExtendedProfileComment = "En activant cette option, l'utilisateur pourra compléter les champs facultatifs suivants: \"Mon espace personnel\", \"Mes compétences\", \"Mes diplômes\", \"Mes compétences professionnelles\", qui définiront son portfolio sur le réseau social.";
$Classes = "Classes";
...
$ExtendedProfileRegistrationTitle = "Champs du portfolio à l'enregistrement";
$ExtendedProfileRegistrationComment = "Parmi les champs suivants du portfolio, lesquels doivent être disponibles lors du processus d'enregistrement des utilisateurs? Ceci nécessite que le portfolio à l'enregistrement soit activé (voir plus haut).";
$ExtendedProfileRegistrationRequiredTitle = "Champs du portfolio demandés lors de l'enregistrement";
$ExtendedProfileRegistrationRequiredComment = "Parmi les champs du portfolio, lesquels sont obligatoires lors de l'enregistrement des utilisateurs? Ceci nécessite que l'option du portfolio à l'enregistrement soit activée et que les champs soient disponibles dans le formulaire d'inscription (voir ci-dessus).";
...
$TotalSpaceUsedByPortalXLimitIsYMB = "Espace total utilisé par le portail : %s (limite configurée de %sMB)";
...
$ThereAreUsersOrCoursesUsingThisLanguageYouWantToDisableThisLanguageAndSetUsersAndCoursesWithTheDefaultPortalLanguage = "Des utilisateurs ou des cours utilisent actuellement cette langue. Voulez-vous la désactiver quand même et modifier la langue de tous ces utilisateurs et cours à la langue par défaut du portail ?";
$ReportQuarterlyUsers = "Nombre d'utilisateurs inscrits et connectés";
$NumberOfUsersRegisteredTotal = "Nombre d'utilisateurs inscrits (total)";
$NumberOfUsersRegisteredCompared = "Nombre d'utilisateurs inscrits (nouveaux p/r au trimestre antérieur)";
$NumberOfUsersWhoConnected = "Nombre d'utilisateurs connectés";
$IncompleteDataCurrentQuarter = "*: Trimestre actuel, données incomplètes";
$QuarterXQY = "T%s %s";
$YoY = "Annuel";
$ReportQuarterlyCourses = "Nombre de cours existants et disponibles";
$NumberOfExistingCoursesTotal = "Nombre de cours existants (total)";
$NumberOfAvailableCourses = "Nombre de cours disponibles (non fermés ni cachés, total)";
$ReportQuarterlyHoursOfTraining = "Heures de formation";
$NumberOfHoursTrainingFollowed = "Nombre d'heures de formations suivies (total)";
$ReportQuarterlyNumberOfCertificatesGenerated = "Nombre de certificats générés";
$NumberOfCertificatesGeneratedTotal = "Nombre de certificats générés (total)";
$ReportQuarterlySessionsByDuration = "Nombre de sessions, par durée";
$SessionsByDurationByQuarter = "Sessions par durée (par trimestre)";
$ReportQuarterlyCoursesAndSessions = "Nombre de cours, sessions et utilisateurs inscrits";
$ListOfCoursesCodes = "Liste de codes de cours";
$NumberOfSubscribedUsers = "Nombre d'utilisateurs inscrits";
$NumberOfUsersWhoFinishedCourse = "Nombre d'utilisateurs qui ont terminé le cours (selon l'outil de cahier de notes)";
$ListOfCoursesCodesAndSessions = "Liste de codes de cours et sessions";
...
$ExportCoursesReportsComplete = "Export des rapports de cours complet";
$NumberOfQuestionsLimitedFromXToY = "Le nombre de questions est limité entre %d et %d.";
