...
$GenerateCustomReport = "Gere relatório personalizado";
$ToDo = "Façam";
$PleaseEnterURL = "Por favor insira o URL";
...
$CourseHoursDuration = "Duração do curso (h)";
$AnnouncementWillBeSentTo = "Anúncio será enviado para";
...
$CreateNewSurveyDoodle = "Criar uma nova pesquisa do tipo Doodle";
$RemoveMultiplicateQuestions = "Remover perguntas multiplicadas";
$MultiplicateQuestions = "Questões multiplicadas";
$QuestionTags = "Você pode usar as tags {{class_name}} e {{student_full_name}} na pergunta para multiplicar as perguntas. Na página da lista da pesquisa, no campo de ação, você tem um botão para multiplicar a pergunta que procurará a tag {{class_name}} e duplicar a pergunta para todas as classes inscritas no curso e renomeá-las com o nome da turma. Ele também adicionará uma página finalizando para criar uma nova página para cada classe. Em seguida, ele procurará a tag {{student_full_name}} e duplicará a pergunta para todos os alunos da turma (para cada turma) e a renomeará com o nome completo do aluno.";
$CreateMeeting = "Criar enquete de reunião";
$QuestionForNextClass = "Pergunta para a próxima aula";
$NewExerciseAttemptDisabled = "O portal não tem permissão para iniciar novo teste no momento, por favor volte mais tarde.";
$PersonalDataOfficer = "Oficial de dados pessoais";
$MaxNumberSubscribedStudentsReached = "O número máximo de alunos já foi atingido, não é possível se inscrever mais estudantes.";
$UserXAddedToCourseX = "Usuário %s foi registrado no curso %s";
$LpMinTime = "Tempo Mínimo (minutos)";
$LpMinTimeDescription = "Tempo mínimo (em minutos) o aluno deve permanecer no caminho de aprendizagem para ter acesso ao próximo.";
$LpMinTimeWarning = "Você não gastou o tempo mínimo necessário no caminho de aprendizado.";
$YouHaveSpentXTime = "Você gastou %s";
$TimeSpentInLp = "Tempo gasto no caminho de aprendizado";
$StudentXFinishedLp = "Aluno %s completou seus caminhos de aprendizagem.";
$IHaveFinishedTheLessonsNotifyTheTeacher = "Eu terminei as lições, notifico o professor";
$TheStudentXHasFinishedTheCourseYLearningPaths = "O aluno %s terminou os percursos de aprendizagem do curso %s";
$ThisQuestionExistsInAnotherExercisesWarning = "Esta questão é usada em outros exercícios. Se você continuar sua edição, as alterações afetarão todos os exercícios que contiverem essa questão.";
$TimeSpentTimeRequired = "Tempo gasto / tempo necessário";
$ProgressSpentInLp = "Progresso";
$InSessionXYouHadTheFollowingResults = "Na sessão %s, você teve os seguintes resultados";
$TimeSpent = "Tempo gasto";
$NumberOfVisits = "Número de visitas";
$FormationUnit = "Unidade de formação";
...
$SurveyXMultiplicated = "Pesquisa %s multiplicada";
$SurveyXNotMultiplicated = "Pesquisa %s não multiplicada";
$ExportSurveyResults = "Exportar resultados de pesquisa";
$PointAverage = "Pontuação média";
$TotalScore = "Soma da pontuação";
$ExportResults = "Resultados de exportação";
$QuizBrowserCheckOK = "Seu navegador foi verificado. Você pode prosseguir com segurança.";
$QuizBrowserCheckKO = "Não foi possível verificar seu navegador. Tente novamente ou tente outro navegador ou dispositivo antes de iniciar o teste.";
$PartialCorrect = "Parcialmente correta";
$XAnswersSavedByUsersFromXTotal = "%d / %d respostas salvas.";
$TestYourBrowser = "Teste seu navegador";
...
$SurveyQuestionSelectiveDisplay = "Display seletivo";
...
$LoadingXUsers = "Carregando %d usuários...";
$AnonymizingXUsers = "Tornando %d usuários anônimos...";
...
$PendingStudentPublications = "Tarefas pendentes";
$MyStudentPublicationsTitle = "Todas as atribuições";
$MyStudentPublicationsExplanation = "Você encontrará abaixo todas as suas tarefas de todos os cursos e sessões em que está inscrito.";
$RequiredCourses = "Cursos requeridos";
$SimpleCourseList = "Lista Padrão";
$AdminCourseList = "Lista de Gestão";
$AnonymizeUserSessions = "Anonimizar as sessões do usuário";
$ContinueLastImport = "Continuar a última importação";
$Notifications = "Notificações";
$Justification = "Justificação";
$PeriodicExport = "Exportação periódica";
$Dates = "Datas";
$ErrorPluginFilesExtensionsInsideZip = "Erro: alguns dos arquivos dentro do pacote zip têm extensões não autorizadas.";
$UsersByStatus = "Usuários por status";
$SessionsPerStatus = "Sessões por status";
$UsersByTargetLanguage = "Usuários por idioma de destino";
$UsersByCareer = "Usuários por carreira";
$UsersByContract = "Usuários por contrato";
$UsersByCertificate = "Usuários por certificado";
$UsersByAge = "Usuários por idade";
$ContinueImport = "Continue a importação";
$LDAPConnectFailed = "Falha na operação de conexão LDAP.";
$LDAPBindFailed = "ldap_bind() falhou.";
$LDAPSearchFailed = "ldap_search() falhou.";
$LDAPFirstEntryFailed = "ldap_first_entry() falhou.";
$LDAPGetValuesFailed = "ldap_get_values() falhou.";
$MoreThanOneAttributeValueFound = "Mais de um valor de atributo foi encontrado.";
$MoreThanOneUserMatched = "Mais de um usuário correspondente.";
$CourseCodeConfirmation = "Confirmação do código do curso";
$UnsupportedQtiVersion = "Versão IMS/QTI sem suporte.";
$ExportAllCertificatesToZIP = "Exportar todos os certificados para ZIP";
$CurrentScore = "Pontuação atual";
$AddAttempt = "Adicionar tentativa";
$SurveysWordInASCII = "Pesquisa";
$PrivateBetweenUsers = "Privado entre usuários";
$Nothing = "Nada";
$CompilatioAnalysisInProgress = "Análise de compilação em andamento";
$AccountExpiration = "Expiração da conta";
$JustificationExpiration = "Expiração da justificativa";
$JustificationType = "Tipo de justificativa";
$Persistent = "Persistente";
$LogoutWithYourAccountFromX = "Saia da sua conta %s";
$DaysDifference = "Diferença de dias";
$Graduated = "Graduado";
$Absent = "Ausente";
$InternalDatabaseError = "Erro de banco de dados interno";
$WrongNumberOfDays = "Número errado de dias";
$SubscriptionNotAllowed = "Assinatura não permitida";
$YouPassedTheLimitOfXMinutesToSeeTheResults = "Você ultrapassou o limite de% s minutos para ver os resultados.";
$LastUpdated = "Ultima atualização";
$Age = "Era";
$ExportToXls = "Exportar para XLS";
$CourseLearningPathsGenericStats = "Estatísticas genéricas de caminhos de aprendizagem";
$FailedToCreateExtraFieldCasUser = "Falha ao criar campo extra cas_user.";
$FailedUserCreation = "Falha ao criar usuário.";
$NoSuchUserInLDAP = "Esse usuário não existe no LDAP.";
$NoSuchUserInInternalDatabase = "Esse usuário não existe no banco de dados interno.";
$CouldNotUpdateUser = "O usuário não pôde ser atualizado.";
$ModelSessionDoesNotExist = "A sessão de modelo não existe.";
$SessionNotRegistered = "Sessão não registrada.";
$CoursesNotAddedToSession = "Cursos não adicionados à sessão.";
$SessionNotFound = "Sessão não encontrada.";
$UserNotFound = "Usuário não encontrado.";
$UserNotSubscribed = "Usuário não inscrito.";
$NoSessionMatched = "Nenhuma sessão encontrada.";
$MoreThanOneSessionMatched = "Mais de uma sessão correspondente.";
$CouldNotLoadUser = "Não foi possível carregar o usuário.";
$LanguageUnavailable = "Idioma indisponível.";
$CouldNotUpdateExtraFieldValue = "Não foi possível atualizar o valor do campo extra.";
$UnsupportedUpdate = "Atualização sem suporte.";
$NoUserMatched = "Nenhum usuário correspondeu.";
$Resume = "Currículo";
$AttendanceFromXToY = "Presença de %s a %s";
$AddTime = "Tempo extra";
$AddUser = "Adicionar usuário";
$TimeSpentOnAssignment = "Tempo gasto na tarefa";
$UserXSignedTheAgreementTheDateY = "O usuário %s assinou o acordo em %s";
$Available = "Acessível";
$SurveyMultipleChoiceWithOther = "Múltipla escolha com 'outra' opção";
$CompilatioDescription = "Módulo anti-plágio Compilatio";
$CompilatioQuota = "Cotas";
$CompilatioCreditXOnY = "Créditos: %s em %s";
$CompilatioConnectionTestSoap = "Teste de conexão SOAP ...";
$CompilatioServerConnection = "Conexão ao servidor SOAP da Compilatio";
$CompilatioConnectionSuccessful = "Conexão bem-sucedida.";
$CompilatioSendTextToServer = "Enviando texto para o servidor Compilatio";
$CompilatioTextSendingTestKeyX = "Este é um teste de envio de texto para o servidor Compilatio por meio de sua API. \ NChave do Compilatio usada: %s";
$CompilatioSuccessfulTransfer = "Transferência bem-sucedida.";
$CompilatioFailedTransfer = "A transferência falhou.";
$CompilatioNoConnection = "Não foi possível conectar ao servidor SOAP do Compilatio.";
$CompilatioParamVerification = "Verifique sua chave, as portas do servidor e possivelmente as configurações de proxy.";
$LastVisitedCourse = "Último curso visitado";
$YouDidNotVisitACourseHereTheCourseList = "Você ainda não visitou nenhum curso, aqui está a lista de seus cursos.";
?>