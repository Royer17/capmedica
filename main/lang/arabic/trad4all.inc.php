...
$MyTeachingCapabilitiesHelp = "يمكنك ان تذكر هنا المقررات والمهارات التي تستطيع ان تعليمها للاخرين، ويمكنك ترك هذا الحقل فارغا";
$UserGuides = "ادلة المستخدم";
$MyProductionsHelp = "هل كتبت ورقة يمكنك مشاركتها ، أو تريد إرفاق سيرتك الذاتية للتحميل؟ أضف هؤلاء هنا";
$CorrectAttempts = "محاولات صحيحة";
$WrongAttempts = "محاولات غير صحيحة";
$StudentsWithCorrectAnswers = "الطلبة ذوي الاجابات الصحيحة";
$StudentsWithWrongAnswers = "الطلبة ذوي الاجابات غير الصحيحة";
$ContentList = "قائمة المحتويات";
$Tariff = "التعريفة";
$ToInvoice = "على الفاتورة";
$LearningPathItemByAuthor = "عنصر مسار التعلم وفقا للمؤلف";
$DeleteExerciseAttempts = "احذف ايضا محاولات التمرين، اذا لم تؤشر هذا الاختيار فان نتائج التمرين ستبقى موجودة في اداة التمرين";
$ExerciseCategoriesRadarMode = "اظخر فقط النقاط بشكل مخطط راداري بدلا من جدول الفئات، من دون اظهار النقاط والتغذية العكسية على مستوى الفرد";
$ExerciseBlockBecausePercentageX = "تم حجم كافة المحاولات لانك لم تصل الى الحد الادنى من النقاط %s % في اي من محاولاتك";
$RegisteredAuthors = "المؤلفين الذين تم تسجيلهم";
$Price = "السعر";
$PriceUpdated = "تم تحديث السعر";
$RemoveSelected = "ازالة المؤلفين الذين تم تحديدهم";
$DeletedAuthors = "تم ازالة المؤلفين";
$HideCategoryTable = "اخفاء جدول الفئة";
$XQuestionsSelectedWithTotalScoreY = "فقط %d اسئلة سيتم اختيارها في تهيئة الاختبار، ولنقاط مجموعها %s";
