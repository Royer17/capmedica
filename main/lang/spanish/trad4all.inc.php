...
$ClarContent3 = "</p><p><b>Teoría Educativa</b><p>Para los profesores, preparar un curso en Internet es principalmente una cuestión de Teoría Educativa.";
$ClarContent4 = "están a su disposición para ayudarle durante los pasos de la evolución de su proyecto de formación: desde el diseño de las herramientas a su integración en una estrategia coherente y clara con una evaluación de su impacto en el aprendizaje de los estudiantes.</p>";
...
$AsciiSvgComment = "Activar el plugin AsciiSVG en el editor WYSIWYG para dibujar diagramas a partir de funciones matemáticas.";
...
$YouHaveMoreThanXCourses = "¡Tiene más de %d cursos en su plataforma Chamilo! Solamente se han actualizado los cursos de %d. Para actualizar los otros cursos, %s haga clic aquí  %s";
...
$YouHaveBeenInvitedJoinNow = "Ud. ha sido invitado a unirse ahora";
...
$New = "Nuevo";
$YouMustToInstallTheExtensionLDAP = "Tu debes instalar la extensión LDAP";
...
$MagicQuotesGpcInfo = "Permite escapar automáticamente valores de GET, POST y COOKIES. Una característica similar es provista para  los datos requeridos en este software, así que su uso provoca una doble barra de escape en los valores.";
...
$ActivityCoach = "El tutor de la sesión, tendrá todos los derechos y permisos en todos los cursos que pertenecen a la sesión.";
...
$OralQuestionsAttempted = "Un estudiante ha entregado una pregunta oral o más";
...
$Letters = "Letras";
$NewHomeworkEmailAlert = "Avisar a los estudiantes con un correo electrónico, la creación de una nueva tarea";
$NewHomeworkEmailAlertEnable = "Activar el aviso de la creación de una nueva tarea";
$NewHomeworkEmailAlertDisable = "Desactivar el aviso de la creación de una nueva tarea";
...
$PleaseAllowUsALittleTimeToSubscribeYouToOneOfOurCourses = "Permítanos un poco de tiempo para suscribirse a uno de nuestros cursos. Si considera que nos olvidamos de Ud., póngase en contacto con los administradores del portal. Puede encontrar sus datos de contacto en el pie de página.";
...
$AllUsersAreAutomaticallyRegistered = "Todos los usuarios serán agregados automáticamente";
...
$EnabledStudentExport2PDFComment = "Esta prestación está habilitada por defecto, pero en caso de sobrecarga del servidor por abuso de ella, o en entornos de formación específicos, puede que desee desactivarla en todos los cursos.";
...
$YouAreUsingChamiloInAWindowsPlatformSadlyYouCantConvertDocumentsInOrderToSearchTheContentUsingThisTool = "Está usando Chamilo en una plataforma Windows. Lamentáblemente, no puede convertir los documentos para indexarlos usando esta herramienta.";
...
$NoUniqueScoreRanges = "No existe ningún rango posible de puntuaciones.";
...
$GradebookEnableGradeModelComment = "Permite utilizar un modelo de calificacíon en el cuaderno de evaluaciones";
...
$CertificateHideExportLinkComment = "Activar para eliminar completamente la posibilidad de exportar certificados (para cualquier usuario). Si está activado, sobrescribe el valor configurado para el acceso a certificados para estudiantes.";
...
$EnableGamificationMode = "Activar modo de ludificación";
$MyCoursesSessionView = "Mis cursos, vista sesión";
$DisableGamificationMode = "Desactivar modo de ludificación";
...
$ShowAdditionalColumnsInStudentResultsPageComment = "Muestra columnas adicionales en la vista estudiante de la herramienta de evaluaciones. Estas columnas dan el mejor resultado del salón, la posición correlativa del alumno frente a los demás, y el promedio de todas las notas del salón.";
...
$SpecificDate = "Envío en fecha concreta";
...
$OralExpressionHelpText = "Cuando lanza la grabación, puede pausar cuando lo desee. Si no está satisfecho, grábese de nuevo. Esto sobrescribirá la versión anterior. Satisfecho? El archivo esta automáticamente enviado al servidor, se puede seguir con el ejercicio.";
...
$ExerciseCategoryAllSessionsReport = "Informe de ejercicio por categoría en todas las sesiones";
...
$PersonalDataPermissionsYouGaveUs = "Permisos que nos dio";
...
$PersonalDataConsultationTitle = "Consulta de sus datos personales";
...
$DegreeOfCertaintyPrettySureDescription = "Dio la respuesta correcta pero no estaba completamente seguro (entre 60% y 70% seguro)";
...
$DegreeOfCertaintyUnsureDescription = "Dio la respuesta incorrecta, pero intuía que no era correcta (60% a 70% de certeza)";
$DegreeOfCertaintyVeryUnsure = "Muy inseguro";
$DegreeOfCertaintyVeryUnsureDescription = "Dio la respuesta incorrecta a pesar de tener 80% de certeza de que no era la correcta";
...
$ThereIsASequenceResourceLinkedToThisSessionYouNeedToDeleteItFirst = "Existe un recurso de secuencia vinculado a esta sesión. Tiene que borrar el vínculo primero.";
...
$Terms_and_conditionFields = "Campos de términos y condiciones";
...
$MaxNumberSubscribedStudentsReached = "Se ha llegado al numero máximo de alumnos inscritos en el curso, no se puede inscribir mas.";
...
$YouHaveSpentXTime = "Has invertido %s";
...
$TimeSpentTimeRequired = "Tiempo invertido / Tiempo mínimo requerido";
$ProgressSpentInLp = "Progreso contenidos";
$InSessionXYouHadTheFollowingResults = "En la sesión %s, usted tiene los siguientes resultados";
$TimeSpent = "Tiempo empleado";
$NumberOfVisits = "Número de visitas";
$FormationUnit = "Unidad de capacitación";
$GlobalProgress = "Progreso global";
$AttestationOfAttendance = "Atestación de asistencia";
$DontShowScoreOnlyWhenUserFinishesAllAttemptsButShowFeedbackEachAttempt = "No mostrar el puntaje (sólo cuando el usuario finaliza todos los intentos) pero mostrar la retroalimentación por cada intento.";
...
$PersonalDataCollectionTitleHelp = "¿Porqué recolectamos estos datos?";
$PersonalDataRecordingTitleHelp = "¿Dónde registramos los datos? (en qué sistema, alojado dónde, accesible para qué empresa que se encarga de los servidores, etc.)";
$PersonalDataOrganizationTitleHelp = "¿Cómo están estructurados los datos? ¿En qué medida la organización de los datos protege su seguridad?... ¿Tiene procesos establecidos que aseguran que un hacker no podrá recolectar todos los datos personales en el primer intento? ¿están cifrados?)";
$PersonalDataStructureTitleHelp = "¿Cómo se estructuran los datos en la aplicación? (una solo ficha para todos los datos, tiene alguna categorización / etiqueta, ...)";
$PersonalDataConservationTitleHelp = "¿Cuánto tiempo guardamos los datos? ¿Existen datos que expiran a pesar de que la cuenta siga activa? ¿Cuánto tiempo los guardamos después del último uso del sistema?";
$PersonalDataAdaptationTitleHelp = "¿Qué cambios podemos hacer a los datos? ¿Qué cambios se pueden hacer a los datos sin afectar el servicio?";
$PersonalDataExtractionTitleHelp = "¿Para qué extraemos datos (hacia otros procesos internos) y cuáles son?";
$PersonalDataConsultationTitleHelp = "¿Quién puede consultar los datos personales?, ¿Con qué propósito?";
$PersonalDataUsageTitleHelp = "¿Cómo y para qué podemos usar los datos personales?";
$PersonalDataCommunicationTitleHelp = "¿Con quién podemos compartirlos?, ¿En qué oportunidades?, ¿A través de qué procesos (seguros o no)?";
$PersonalDataInterconnectionTitleHelp = "¿Tenemos otro sistema con el cual Chamilo interactúa? ¿Cuál es el proceso de interconexión? ¿Cuáles son los datos intercambiados y de qué manera?";
$PersonalDataLimitationTitleHelp = "¿Cuáles son los límites que respetaremos siempre al usar datos personales? ¿Hasta qué punto podemos llegar?";
...
$SearchUserByGeolocalization = "Por geolocalización";
$GiveRevision = "Dar revisión";
$ForumPostReported = "Post reportado";
$UserXReportedPostXInForumX = "El usuario %s ha reportado el mensaje %s en el foro %s";
$MyCommunities = "Mis comunidades";
$SeeAllCommunities = "Ver todas las comunidades";
...
$IsItEditableByTheInvitees = "Evento editable por los invitados";
$Invitees = "Invitados";
$RemindXLpCourseX = "Recordatorio %s del curso %s";
$HelloX = "Hola %s";
$YouAreRegCourseXFromDateX = "Estás registrado en la formación %s desde el %s";
...
$ReportQuarterlyUsers = "Número de usuarios registrados y conectados";
$NumberOfUsersRegisteredTotal = "Número de usuarios registrados (total)";
$NumberOfUsersRegisteredCompared = "Número de usuarios registrados (trimestre nuevo vs anterior)";
$NumberOfUsersWhoConnected = "Número de usuarios que se conectaron";
$IncompleteDataCurrentQuarter = "*: Trimestre actual, datos incompletos";
$QuarterXQY = "T%s %s";
$YoY = "Interanual";
$ReportQuarterlyCourses = "Número de cursos existentes y disponibles";
$NumberOfExistingCoursesTotal = "Número de cursos existentes (total)";
$NumberOfAvailableCourses = "Número de cursos disponibles (ni cerrados ni ocultos, total)";
$ReportQuarterlyHoursOfTraining = "Horas de formación";
$NumberOfHoursTrainingFollowed = "Número de horas de formación seguidas (total)";
$ReportQuarterlyNumberOfCertificatesGenerated = "Número de certificados generados";
$NumberOfCertificatesGeneratedTotal = "Número de certificados generados (total)";
$ReportQuarterlySessionsByDuration = "Número de sesiones por duración";
$SessionsByDurationByQuarter = "Sesiones por duración (por trimestre)";
$ReportQuarterlyCoursesAndSessions = "Número de cursos, sesiones y usuarios inscritos";
$ListOfCoursesCodes = "Lista de códigos de curso";
$NumberOfSubscribedUsers = "Número de usuarios inscritos";
$NumberOfUsersWhoFinishedCourse = "Número de usuarios que terminaron el curso (según se define en evaluaciones)";
$ListOfCoursesCodesAndSessions = "Lista de códigos de curso y sesiones";
...
$LpAiWordsCountHelper = "Número máximo aproximado de palabras (en realidad el número de tokens) deseado por página. A más tokens, probablemente se genere una mejor calidad de contenido, pero también tomará más tiempo y terminará costando más a su organización. Usar con moderación.";
...
$EmailPicture = "Imagen de cabecera";
$AddEmailPicture = "Añadir imagen de cabecera";
