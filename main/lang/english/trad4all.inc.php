...
$ExtendedProfileTitle = "Portfolio";
$ExtendedProfileComment = "If this setting is on, a user can fill in the following (optional) fields: 'My personal open area', 'My competences', 'My diplomas', 'What I am able to teach'";
$Classes = "Classes";
...
$ExtendedProfileRegistrationTitle = "Portfolio fields at registration";
$ExtendedProfileRegistrationComment = "Which of the following fields of the portfolio have to be available in the user registration process? This requires that the portfolio option be enabled (see above).";
$ExtendedProfileRegistrationRequiredTitle = "Required portfolio fields in registration";
$ExtendedProfileRegistrationRequiredComment = "Which of the following fields of the portfolio are *required* in the user registration process? This requires that the portfolio option be enabled and that the field be also available in the registration form (see above).";
...
$TheUserXNotYetAchievedTheSkillX = "The user %s has not achieved the skill \"%s\" yet";
...
$AddEventInCourseCalendar = "Add event in course calendar";
$Hours = "Hours";
$ReminderXEvent = "Reminder for event : %s";
...
$Invitees = "Invitees";
$RemindXLpCourseX = "Reminder number %s for the course %s";
$HelloX = "Hello %s";
$YouAreRegCourseXFromDateX = "You are registered in the training %s since the %s";
...
$QuestionInOtherExercises = "This question is shared with other exercises, are you sure you want to delete it?";
$SeeForTablet = "View for tablet";
$DisableSignature = "Disable signature";
...
$UserXNotSubscribedToCourseX = "User %s has not been registered to course %s";
...
$ReportQuarterlyUsers = "Number of users registered and connected";
$NumberOfUsersRegisteredTotal = "Number of users registered (total)";
$NumberOfUsersRegisteredCompared = "Number of users registered (new vs previous quarter)";
$NumberOfUsersWhoConnected = "Number of users who connected";
$IncompleteDataCurrentQuarter = "*: Current quarter, incomplete data";
$QuarterXQY = "Q%s %s";
$YoY = "YoY";
$ReportQuarterlyCourses = "Number of existing and available courses";
$NumberOfExistingCoursesTotal = "Number of existing courses (total)";
$NumberOfAvailableCourses = "Number of available courses (not closed or hidden, total)";
$ReportQuarterlyHoursOfTraining = "Hours of training";
$NumberOfHoursTrainingFollowed = "Number of hours of training followed (total)";
$ReportQuarterlyNumberOfCertificatesGenerated = "Number of certificates generated";
$NumberOfCertificatesGeneratedTotal = "Number of certificates generated (total)";
$ReportQuarterlySessionsByDuration = "Number of sessions per duration";
$SessionsByDurationByQuarter = "Sessions per duration (by quarter)";
$ReportQuarterlyCoursesAndSessions = "Number of courses, sessions and subscribed users";
$ListOfCoursesCodes = "List of course codes";
$NumberOfSubscribedUsers = "Number of subscribed users";
$NumberOfUsersWhoFinishedCourse = "Number of users who finished the course (as defined in gradebook)";
...
$LpAiGenerator = "AI learning path generator";
$LpAiTopic = "Topic";
$LpAiTopicHelp = "Type the topic on which you want the AI Helper to develop a learning path. The more detailed the topic, the more precise the result will be.";
$LpAiNumberOfItems = "Number of learning path items";
