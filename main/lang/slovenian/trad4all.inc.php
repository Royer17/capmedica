...
$CompanyReportResumed = "Poslovno poročilo - kratka inačica";
$CompanyReport = "Poslovno poročilo";
$Report = "Poročilo";
$TraceIP = "Sledi IP";
...
$RemoveOldRelationships = "Odstrani predhodne povezave";
...
$AllowOnlyText = "Dovoli zgolj besedilo";
...
$HereIsYourFeedback = "Tvoje povratne informacije";
...
$DocumentsWillBeAddedToo = "Pripadajači dokumenti bodo dodani izvozu avtomatično.";
...
$Force = "Z nizom vprašanj in podvprašanj prisilite sogovornika, da prizna, da ne ve, za kar trdi, da ve.";
...
$AgendaText = "Splošen uvod v filozofijo in metodologijo principov";
$Micro = "Ulične ankete";
...
$PermanentlyRemoveFilesTitle = "Brisanih datotek ni možno obnoviti";
...
$DropboxMaxFilesizeTitle = "Nabiralnik: Največja velikost dokumenta v nabiralniku";
...
$ScormAndLPTestTotalAverage = "Povprečje rezultatov testov v učnih poteh";
...
$MailCronCourseExpirationReminderSubject = "Nujno: Opomnik o poteku tečaja %s";
...
$ToolCourseMaintenance = "Vzdrževanje";
...
$ShowLinkBugNotificationTitle = "Pokaži povezavo za poročanje o napakah";
...
$CourseValidationTermsAndConditionsLinkComment = "Predstavlja URL k dokumentu \"Pogoji rabe\", ki je veljaven ob zahtevi po kreiranju tečaja. V primeru, da je naslov podan, mora uporabnik pred pošiljanjem zahteve prebrati in sprejeti pogoje predstavljene v dokumentu.<br />
...
$YouShouldCreateTermAndConditionsForAllAvailableLanguages = "Priporočljivo je, da za vsakega izmed jezikov kreirate dokument s \"Pogoji rabe\".";
...
$DRHPageAfterLoginTitle = "Stran po prijavi za HRM";
...
$AutoDetectLanguageCustomPagesTitle = "Omogoči avtomatično detekcijo jezika na lastnih (custom) straneh portala.";
...
$CookieWarningComment = "Ko je možnost omogočena, se prikaže pasica, ki uporabnika obvešča o uporabi piškotkov. Pasico je na enostaven način mogoče potrditi in jo skriti s strani uporabnika. Pasica omogoča platformi, da zadosti regulativi EU Parlamenta o uporabi piškotkov.";
...
$UserXHasBeenAssignedToBossWithUrlX = "Dodeljeni ste bilo kot tutor učeči/učečemu %s.<br />
Profil dodeljene-ga je dosegljiv tule: %s";
$ShortName = "Kratko ime";
$Portal = "Portal";
$CourseUserDocument = "Dokumenti uporabnika tečaja";
$Destination = "Cilj";
...
$WallMessagesPosted = "Sporočila objavljena na njenem/njegovem zidu";
...
$WebRTCDialogHelp = "Da bi omogočili video klepet v vašem brskalniku (če brskalnik to omogoča), kliknite informacijsko ikono levo od URL in dovolite rabo spletne kamere in mikrofona med klepetom.";
...
$Portfolio = "Portfelj";
$AddPortfolioItem = "Dodaj element v portfelj";
...
$EditPortfolioItem = "Uredi element portfelja";
$PortfolioItemAdded = "Element je bil dodan v portfelj";
...
$AddAnnotationText = "Označi z besedilom";
$AddAnnotationPath = "Nariši označbo";
...
$TheUserXAskedLegalConsentWithdrawalWithJustificationXGoHereX = "Uporabnica/uporabnik %s je zaprosil za preklic svojih soglasij v skladu s pravnimi pogoji portala z obrazložitvijo: \"%s\". Zahtevek lahko obravnavate tule: %s";
...
$CreateMeeting = "Ustvari anketo sestanka";
...
$CompilatioAnalysis = "Analiziraj";
$CompilatioAnalysisPercentage = "(procent analize datoteke)";
...
$CompilatioConnectionWithServer = "Povezovanje s Compilatio strežnikom";
$CompilatioWithCompilatio = "s Compilatio";
$CompilatioStartAnalysis = "Začni analizo s Compilatio";
$CompilatioSeeReport = "Poglej poročilo";
$CompilatioNonToAnalyse = "Vaša izbira ne vsebuje opravil za analizo. Poslana so lahko zgolj še NE-skenirana opravila and opravila upravljana s Compilatio.";
$CompilatioComunicationAjaxImpossible = "AJAX komunikacija s Compilatio strežnikom ni mogoča. Prosimo da skušate ponoviti kasneje.";
$UserClassExplanation = "Info: Seznam razredov spodaj vključuje razrede, ki ste jih že vpisani v ta tečaj. Če je seznam prazen, uporabite ikono zgoraj z zelenim + znakom za dodajanje želenih razredov.";
$InsertTwoNames = "Vpiši svoji dve imeni";
$AddRightLogo = "Dodaj desni logotip";
...
$LearnpathCategory = "Kategorije učnih poti";
...
$CourseInSession = "Tečaji v sejah";
...
$HelloXGroupX = "Pozdravljen %s<br /><br />
Kot tutor skupine %s si povabljen k sodelovanju z izpolnitvijo naslednjega vprašalnika:";
...
$PartialCorrect = "Delno pravilno";
$XAnswersSavedByUsersFromXTotal = "%d / %d odgovorov je bilo shranjenih.";
$TestYourBrowser = "Preskusi svoj brskalnik";
$AverageTrainingTime = "Povprečen čas v tečaju";
$UsersActiveInATest = "Uporabniki aktivni v testu";
$SurveyQuestionMultipleChoiceWithOtherComment = "Podajte nekaj pred-definiranih možnosti, potem pa pustite uporabniku, da možnost izbere ali pa odgovori z besedilom, če mu nobena od podanih možnosti ne ustreza.";
$SurveyOtherAnswerSpecify = "Drugo:";
$SurveyOtherAnswer = "Prosim, opredelite:";
$UserXPostedADocumentInCourseX = "Tečajnik %s je oddal dokument v orodje Zadolžitve v tečaju %s";
$DownloadDocumentsFirst = "Najprej prenesite dokument.";
$FileXHasNoData = "Datoteka %s je prazna ali vsebuje zgolj prazne vrstice.";
$FileXHasYNonEmptyLines = "Datoteka %s vsebuje %d nepraznih vrstic.";
$DuplicatesOnlyXUniqueUserNames = "Prepoznani duplikati: pridobljenih je bilo zgolj %d enoličnih uporabniških imen.";
$NoLineMatchedAnyActualUserName = "Nobena izmed vrstic ne ustreza nobenemu izmed dejanskih uporabniških imen.";
$OnlyXLinesMatchedActualUsers = "Zgolj %d vrstic ustreza dejanskim uporabniškim imenom.";
$TheFollowingXLinesDoNotMatchAnyActualUser = "Naslednjih %d vrstic ne ustreza nobenemu izmed dejanskih uporabnikov:";
$XUsersAreAboutToBeAnonymized = "%d uporabnikov bo anonimizirano:";
$LoadingXUsers = "Nalagam uporabnike %d ...";
$AnonymizingXUsers = "Anonimiziram uporabnike: %d ...";
$AllXUsersWereAnonymized = "Vseh %d uporabnikov je bilo anonimiziranih.";
$OnlyXUsersWereAnonymized = "Zgolj %d uporabnikov je bilo anonimizirano.";
$AttemptedAnonymizationOfTheseXUsersFailed = "Poskus anonimizacije sledečih %d uporabnikov ni uspel:";
$PleaseUploadListOfUsers = "Prosim, naložite besedilno datoteko s seznamom uporabnikov, ki jih želite anonimizirati. Specificirajte eno uporabniško ime na vrstico datoteke.";
$InternalInconsistencyXUsersFoundForYUserNames = "Ugotovljena notranja nedoslednost: ugotovljenih je bilo %d uporabnikov iz posredovanih %d uporabniških imen. Prosimo da  pričnete ponovno.";
$BulkAnonymizeUsers = "Anonimiziraj seznam uporabnikov";
$UsernameList = "Seznam uporabniških imen";
$UsersAboutToBeAnonymized = "Uporabniki, ki bodo anonimizirani";
$CouldNotReadFile = "Ne morem brati datoteke.";
$CouldNotReadFileLines = "Ne morem prebrati vrstic datoteke.";
$CertificatesSessions = "Certifikati v sejah";
$SessionFilterReport = "Filtriraj certifikate v sejah";
$UpdateUserListXMLCSV = "Ažuriraj seznam uporabnikov";
$DonateToTheProject = "Chamilo je odprtokodni (Open Source) projekt in je s strani združenja Chamilo (Chamilo Association)  uporabnikov zagotovljen brezplačno s tendenco zasledovanja cilja izboljšanja dostopnosti do kvalitetnega izobraževanja po vsem svetu.<br /><br />
Vendar: sam razvoj Chamilo in zagotavljanje storitev terjata določena finančna vlaganja, in vsakršna pomoč z vaše strani je dobrodošla v nadaljnem zagotavljanju teh storitve in njihovih izboljšav v prihajajočih obdobljih.<br /><br />
Kreiranje tečaja na tem portalu je ena on najbolj potrošno-intenzivnih operacij glede rabe (plačljivih) virov. Zato vas, predenj kreirate tečaj, prosimo, da razmislite o donaciji združenju Chamilo, da bi to storitev lahko obdržali zastonj in prosto dostopno tudi v prihodnosti.";
$MyStudentPublications = "Moje zadolžitve";
$AddToEditor = "Dodaj v urejevalnik";
$ImageURL = "URL slike";
$PixelWidth = "širina v px";
$DeleteInAllLanguages = "Odstrani v vseh jezikih";
$QuizConfirmSavedAnswers = "Sprejemam število sranjenih odgovorov v tem razdelku.";
$QuizConfirmSavedAnswersHelp = "Če se ne strinjate, ne potrdite strinjanja. V tem primeru vam priporočamo, da se posvetujte z upraviteljem tečaja ali upraviteljem platforme.";
$StudentPublicationsSent = "Poslane ali pretekle zadolžitve";
$PendingStudentPublications = "Čakajoče zadolžitve";
$MyStudentPublicationsTitle = "Vse zadolžitve";
$MyStudentPublicationsExplanation = "Spodaj se nahajajo vse vaše zadolžitve iz vseh tečajev in sej v katere ste vpisani.";
$RequiredCourses = "Zahtevani tečaji";
$SimpleCourseList = "Običajen seznam";
$AdminCourseList = "Upravljalni seznam";
$AnonymizeUserSessions = "Anonimiziraj uporabnikovo sejo";
$ContinueLastImport = "Nadaljuj zadnji uvoz";
$Notifications = "Obvestila";
$Justification = "Dokazilo";
$PeriodicExport = "Periodični izvoz";
$Dates = "Datumi";
$ErrorPluginFilesExtensionsInsideZip = "Napaka: nekatere datoteke znotraj zip paketa imajo nedovoljene končnice.";
$UsersByStatus = "Uporabniki po statusih";
$UsersByCertificate = "Uporabniki po certifikatih";
$UsersByAge = "Uporabniki po starosti";
$ContinueImport = "Nadaljuj uvoz";
$LDAPConnectFailed = "LDAPP connect operacija ni uspela.";
$LDAPBindFailed = "LDAP_bind() operacija ni uspela.";
$LDAPSearchFailed = "LDAP_search() operacija ni uspela.";
$LDAPFirstEntryFailed = "LDAP_first_entry() operacija ni uspela.";
$LDAPGetValuesFailed = "LDAP_get_values() ni uspela.";
$MoreThanOneAttributeValueFound = "Več kot ena vrednost za atribut je bila najdena.";
$MoreThanOneUserMatched = "Več kot en sam uporabnik ustreza kriteriju.";
$UnsupportedQtiVersion = "Nepodprta IMS/QTI različica.";
$ExportAllCertificatesToZIP = "Izvozi vse certifikate v ZIP datoteko.";
$CurrentScore = "Trenutni dosežek";
$AddAttempt = "Dodaj poskus";
$Nothing = "Nič";
$CompilatioAnalysisInProgress = "Izvajanje analize Compilatio ...v teku...";
$JustificationExpiration = "Potek dokazila";
$JustificationType = "Tip dokazila";
$LogoutWithYourAccountFromX = "Odjavi se s svojega računa %s .";
$InternalDatabaseError = "Napaka sistema podatkovne zbirke (notranja)";
$WrongNumberOfDays = "Napačno število dni";
$SubscriptionNotAllowed = "Vpis ni dovoljen";
$Age = "Starost";
$ExportToXls = "Izvozi v XLS";
$FailedToCreateExtraFieldCasUser = "Dodatnega polja cas_user ni mogoče ustvariti.";
$FailedUserCreation = "Uporabnika ni bilo mogoče ustvariti.";
$NoSuchUserInLDAP = "Takega uporabnika ni v LDAP.";
$NoSuchUserInInternalDatabase = "Tak uporabnik v notranji podatkov zbirki ne obstaja.";
$CouldNotUpdateUser = "Uporabnika ni mogoče ažurirati.";
$ModelSessionDoesNotExist = "Predloga seje ne obstaja.";
$SessionNotRegistered = "Seja ni registrirana.";
$CoursesNotAddedToSession = "Tečaji niso bili dodani k seji.";
$SessionNotFound = "Seje ni mogoče najti.";
$UserNotFound = "Uporabnika ni bilo mogoče najti.";
$UserNotSubscribed = "Uporabnik ni vpisan.";
$NoSessionMatched = "Nobena seja ne ustreza.";
$MoreThanOneSessionMatched = "Več kot ena seja ustreza.";
$CouldNotLoadUser = "Ne morem naložiti uporabnika.";
$LanguageUnavailable = "Jezik ni na voljo.";
$CouldNotUpdateExtraFieldValue = "Vrednosti dodatnega polja ni mogoče ažurirati.";
$UnsupportedUpdate = "Nepodprta nadgradnja ali ažuriranje.";
$NoUserMatched = "Noben uporabnik ne ustreza.";
$AttendanceFromXToY = "Prisotnosti od %s to %s";
$AddTime = "Dodaj čas";
$AddUser = "Dodaj uporabnika";
$UserXSignedTheAgreementTheDateY = "Uporabnik %s je podpisal soglasje na %s";
$CompilatioDescription = "
Compilatio anti-plagiatorski modul";
$CompilatioConnectionTestSoap = "Preskus povezave s SOAP strežnkom...";
$CompilatioServerConnection = "Povezava Compilatio SOAP strežnik";
$CompilatioConnectionSuccessful = "Povezava je uspela.";
$CompilatioSendTextToServer = "Pošiljam besedilo k Compilatio strežniku";
$CompilatioTextSendingTestKeyX = "Tole je besedilo poslanega testa na Compilatio strežnik preko njegovega API.\nCompilatio ključ uporabljen pri povezavi: %s";
$CompilatioSuccessfulTransfer = "Prenos je bil uspešen.";
$CompilatioFailedTransfer = "Prenos ni uspel.";
$CompilatioNoConnection = "Povezava s Compilatio SOAP strežnikom ni uspela.";
$CompilatioParamVerification = "Preverite vaš ključ, št. strežnikovih vrat in morebitne nastavitve vašega proxy strežnika.";
$LastVisitedCourse = "Zadnji obiskan tečaj";
$YouDidNotVisitACourseHereTheCourseList = "Niste obiskali še nobenega tečaja, tu je seznam vaših tečajev.";
$RedirectToPortalHome = "Preusmeritev na domačo stran platforme";
$MyLps = "Moje učne poti";
$LastVisitedLp = "Zadnja obiskana učna pot";
$YouDidNotVisitALpHereTheLpList = "Niste obiskali še nobene učne poti. Tu je spisek vaših učnih poti.";
$CourseUsedInOtherURL = "Ta tečaj je uporavljen na vsaj še enem izmed drugih portalov";
$SubscribeUserGroupsToLp = "Dodaj razede k učni poti";
$ReplaceFile = "Nadomesti datoteko";
$WrongAnswer = "Napačen odgovor";
$BlockCategoryExplanation = "Dokončali ste vsa vprašanja v tej kategoriji in to je vaša zadnja možnost, da se vrnete in pregledate svoje odgovore. S klikom na nadaljevanje boste prešli na naslednjo kategorijo vprašanj, s tem pa vračanje na predhodni razdelek testa/vaje ne bo več mogoč.";
$RemainingTimeToFinishExercise = "Preostanek časa za dokončanje vaje/testa";
$RemainingTimeToFinishQuestion = "Preostanek časa za dokončanje vprašanja";
$QuestionStatsDetailedReport = "Podrobno poročilo o vprašanjih";
$MyProductionsHelp = "Napisali ste članek, razpravo, objavo.. ki bi jo želeli deliti, ali pa želite pripeti vaš CV za prenos zainteresiranim? DOdajte te tule.";
$CorrectAttempts = "Pravilni poskusi";
$WrongAttempts = "Nepravilni poskusi";
$StudentsWithCorrectAnswers = "Tečajniki s pravilnimi odgovori";
$StudentsWithWrongAnswers = "Tečajniki z nepravilnimi odgovori";
$LearningPathItemByAuthor = "Elementi učnih poti po avtorjih";
$Price = "Cena";
$PriceUpdated = "Cena je bila ažurirana";
$QuestionAlsoUsedInTheFollowingTests = "To vprašanje je uporabljeno še v naslednjih testih";
$MoveUsersFromCourseToSession = "Prestavi uporabnikove rezultate iz osnovnega tečaja v sejo";
$BackToAttemptList = "Nazaj na seznam poskusov";
$AddGradebookComment = "Komentar";
$LatestLoginInAnyCourse = "Zadnja prijava v tečaj";
$BadgeXTitle = "Značka: %s";
$PortfolioCommentFromXUser = "Komentar s strani %s";
$CopyToMyPortfolio = "Kopiraj v moj portfelj";
$CopyToStudentPortfolio = "Kopiraj v tečajnikov portfelj";
$MarkCommentAsImportant = "Označi komentar kot pomemben";
$UnmarkCommentAsImportant = "Razveljavi pomembnost komentarja";
$PortfolioDetails = "Podrobnosti portfelja";
$PortfolioItemTitle = "Naziv elementa";
$CreationDateXDate = "Datum nastanka: %s";
$UpdateDateXDate = "Datum ažuriranja: %s";
$CategoryXName = "Kategorija: %s";
$DateXDate = "Datum: %s";
$PortfolioItemTitleXName = "Naziv elementa: %s";
$NoItemsInYourPortfolio = "V tvojem portfelju ni elementov";
$PortfolioItems = "Elementi portfelja";
$PortfolioComments = "Komentarji portfelja";
$QualifyThisPortfolioItem = "Oceni ta element";
$PortfolioItemGraded = "Element portfelja je bil ocenjen";
$QualifyThisPortfolioComment = "Oceni ta komentar";
$PortfolioCommentGraded = "Komentar portfelja je bil ocenjen";
$QualifyPortfolioItems = "Oceni elemente";
$QualifyPortfolioComments = "Oceni komentarje";
$ExportMytPortfolioDataPdf = "Izvozi podatke mojega portfelja v PDF";
$ExportMytPortfolioDataZip = "Izvozi podatke mojega portfelja v ZIP datoteko";
$NewLearningPathSubject = "Nova učna pot je na voljo";
$NewLearningPathBody = "Tu je nova učna pot imenovana %s, ki je bila dodana v tvoj tečaj %s. Dostopite do učne poti preko te povezave: %s";
$QuizRemindSubject = "Imate novo sporočilo osebe %s";
$QuizRemindDuration = "Trajanje testa: %s";
$QuizRemindStartDate = "Začetni datum testa: %s";
$QuizRemindEndDate = "Končni datum testa: %s";
$SuccessfulAttempt = "Uspešen poskus";
$FailedAttempt = "Neuspešen poskus";
$StudentWithSuccessfulAttempt = "Tečajniki z uspešnim poskusom";
$StudentWithFailedAttempt = "Tečajniki z neuspešnim poskusom";
$ComparativeGroupReport = "Primerjalno poročilo skupin";
$CoursesUsage = "Uporaba tečaja";
$HideConnectionTime = "Skrij trajanje povezave";
$CourseInWhichTheQuestionWasInitiallyCreated = "Tečaj, v katerem je bilo vprašanje izhodiščno ustvarjeno.";
$ApprenticeshipContract = "Praksa/vajeništvo - kontakti";
$ExportCcVersion13 = "Izvozi Common Cartridge v1.3";
$ImportCcVersion13 = "Uvoz Common Cartridge v1.3";
$ExportCcVersion13Info = "Izvozi vsebine tečaja v obliki IMS Common Cartridge 1.3, za deljenje na drugih platformah";
$ImportCcVersion13Info = "Uvozi tečaj v IMS Common Cartridge 1.3 formatu, iz druge platforme, ki je s to obliko združljiva. Verzija formata je pomembna!";
$IMSCCCreated = "IMS CC datoteka je bila ustvarjena.";
$IMSCCFile = "IMS CC datoteka";
$IMSCCFileImported = "IMS CC datoteka je bila uvožena.";
$IMSCCImportInstructions = "Naloži poljubno IMS CC (.imscc ali .zip) datoteko prave različice. Datoteka bo razširjena direktno v področje tega tečaja.";
$IMSCC13 = "IMS Common Cartridge v1.3";
$HideQuestionNumber = "Skrij številko vprašanja";
$PendingAttempts = "Čakajoči poskusi";
$EditInProfile = "Uredi v profilu";
$RemoveTime = "Odstrani čas";
$UploadAnswer = "Naloži odgovor";
$Corrector = "Korektor";
$CorrectionDate = "Datum korekcije";
$HideAttemptsTableOnStartPage = "Skrij tabelo poskusov na začetni strani";
$HideAssignment = "Skrij zadolžitve";
$MoveTheCurrentSurvey = "Premakni trenuten vprašalnik";
$ShareEventsInSessions = "Deli dogodke v sejah tečaja";
$AgendaEventsInBaseCourseWillBeVisibleInCourseSessions = "Dogodki agende tečaja bodo vidni v sejah";
$AgendaEventsOnlyVisibleInCurrentCourse = "Dogodki agende vidni zgolj v trenutnem tečaju";
$TestResult = "Rezultat testa";
$ShareForumsInSessions = "Deli forume v vseh sejah";
$AddEventInCourseCalendar = "Dodaj dogodek v koledar tečaja";
$ReminderXEvent = "Opomnik za dogodek %s";
$AddNotification = "Dodaj obvestilo";
$NotifyBeforeTheEventStarts = "Obvestilo v opomin na dogodek";
$Invitees = "Vabljeni";
$RemindXLpCourseX = "Opomnik št. %s v tečaju %s";
$HelloX = "Pozdravček %s";
$YouAreRegCourseXFromDateX = "Vpisani ste v usposabljanje %s od %s";
$StepsToRemindX = "Kot opomnik, za dostop do platforme za usposabljanje:<br />1. Dostopite do platforme na naslovu: %s<br />2. Nato vnesite:<br />Vaše uporabniško ime: %s<br />Vaše geslo: Vam je bilo poslano preko e-poštnega sporočila.<br />Če ste ga pozabili ali ga ne morete najti, ga skušajte restavrirati preko: %s<br /><br />Hvala, ker vestno sledite navodilom.";
$LpRemindFooterX = "Učni center<br /><br />
%s<br /><br />
Izobraževalno osebje:<br />
%s";
$Embed = "Pridobi povezavo za vključitev (embedable link)";
$CopyUrlToIncludeInIframe = "Kopiraj ta URL za vključitev te vaje/testa v iframe";
$ExportExtraFields = "Izvozi dodatna polja";
$ToHideExlearners = "Skrij bivše učeče";
$ExportLpQuizResults = "Izvozi rezultate kviza/testa učne poti";
$ElearningResults = "Rezultati učne poti";
$InvoicingByAccessUrl = "Aktivni uporabniki v sejah po posameznih URL";
$SelectTheNextLp = "Naslednja učna pot";
$InLp = "V učni poti";
$ProgressInSessionReport = "Poročilo napredka v sejah";
$QuestionInOtherExercises = "Vprašanje je deljeno z večimi drugimi vajami/testi. Ste prepričani, da ga želite odstraniti?";
$DisableSignature = "Onemogoči podpis";
$EnableSignature = "Omogoči podpis";
$Sign = "Podpis";
$SignView = "Poglej podpis";
$DownloadQr = "Prenesi QR kodo podpisa prisotnosti";
$PasswordRequirementPassed = "Ustreza zahtevam za geslo.";
$PasswordRequirementPending = "Čakanje na izpolnitev zahtev za geslo";
$NewPasswordRequirementMinXSpecials = "Najmanj %s posebnih znakov";
$NewPasswordCannotBeSameAsCurrent = "Novo geslo ne sme biti enako obstoječemu";
?>